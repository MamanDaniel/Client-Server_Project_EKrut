...
class DataBaseUserControllerTest {
	...
	void setUp() throws Exception {
		...
		DataBaseController.connectToDataBase(new DataBaseConnectionDetails("jdbc:mysql://{IP}/ekrut?serverTimezone=IST",
				"localhost", "root", "43941077Rom"),new ServerScreenController());
	...
	/**
	 * checking : get from DB the details on correct username password input : {
	 * "ceo" , 1 } expected: user_ceo1
	 */
	@Test
	...
	/**
	 * checking : get from DB the details on wrong username password input : { "ceo"
	 * , 2 } expected: user_not_exist
	 */
	@Test
	...
	/**
	 * checking : get from null user if the details username not correct 
	 * input :HashMap :  {"ceo" , "2" ,"false"}
	 *  expected: NullPointerException -> if user not exist , the  return data (HashMap <String,Object>) is defined to be null ,cant use get() function
	 */
