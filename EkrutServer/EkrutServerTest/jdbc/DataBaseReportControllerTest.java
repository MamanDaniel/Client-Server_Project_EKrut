...
class DataBaseReportControllerTest {
	...
	/**checking : insert new report wrong format check not exist
	 *  input : { InventoryReport , South , LocalDate.now().getYear()  , LocalDate.now().getMonthValue()  , South } 
	 *  expected : NullPointerException -> The function catchs sql exception and try to print in the server console the messege that fails to insert
	 */
	@Test
